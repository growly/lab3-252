//package benchmarks.pho-mult-add
//
//import Chisel._
//import elastic._
//
//class pho_mult_add(addrWidth: Int = 32, dataWidth: Int = 32) extends Module {
...
//    val RegA2 = UInt(INPUT, dataWidth) // n
//
...
//  val ef0 = Module(new Eager_Fork(2, dataWidth))
...
//
//  //  ef2.io.in.bits=0x%x, ef2.io.in.valid=%d, ef2.io.in.ready=%d,
//  //  ef2.io.out(0).bits=0x%x, ef2.io.out(0).valid=%d, ef2.io.out(0).ready=%d,
//  //  ef2.io.out(1).bits=0x%x, ef2.io.out(1).valid=%d, ef2.io.out(1).ready=%d,
//
...
//
//  //  ef2.io.in.bits, ef2.io.in.valid, ef2.io.in.ready,
//  //  ef2.io.out(0).bits, ef2.io.out(0).valid, ef2.io.out(0).ready,
//  //  ef2.io.out(1).bits, ef2.io.out(1).valid, ef2.io.out(1).ready,
//
...
//  ef1.io.in.bits := ef0.io.out(1).bits + 1.U // increment the loop index
//  b0.io.cond := ef1.io.out(0).bits < io.RegA2 // compare loop index against N
...
//  io.mem_p2_store_idx := st0.io.mem_store_idx
//
//  // Control
...
//  ef0.io.out(1).ready := ef1.io.in.ready
//
//  ef1.io.in.valid := ef0.io.out(1).valid
...
//  fifo1.io.out.ready := ef2.io.in.ready
//
