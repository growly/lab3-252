...
/**
  ...
  * }}}
  */
object FpgaInterfaceMain extends App {
  iotesters.Driver.execute(args, () => new FpgaInterface(addrWidth = 32, regAddrWidth = 5, dataWidth = 32)) {
...
/**
  ...
  * }}}
  */
object FpgaInterfaceRepl extends App {
  iotesters.Driver.executeFirrtlRepl(args, () => new FpgaInterface(addrWidth = 32, regAddrWidth = 5, dataWidth = 32))
}
